...
<div class="lg:grid grid-cols-4">
	<div
		class="my-10 mx-10 p-5 lg:mx-0 space-y-2 col-span-1 lg:flex flex-col justify-between lg:border-r border-black"
	>
	...
	<div
		class="mx-10 py-10 space-y-5 col-span-3 lg:overflow-scroll lg:h-screen lg:max-w-screen-lg lg:mx-auto w-full"
	>
